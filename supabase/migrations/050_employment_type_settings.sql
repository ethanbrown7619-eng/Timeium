-- 050_employment_type_settings.sql
-- Add per-employment-type entitlement settings to organisations.
-- Safe to re-run.

alter table public.organisations
    add column if not exists employment_type_settings jsonb
        not null
        default '{
...
-- Extend the save_org_settings RPC to handle this new column.
