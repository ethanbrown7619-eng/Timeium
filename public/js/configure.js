...
document.querySelectorAll("[data-tab]").forEach((btn) => {
  btn.addEventListener("click", () => {
    ...
    if (activeTab === "settings") { loadSettings(); loadHolidays(); loadLeaveJobMapping(); }
...
// ---------------------------------------------------------------------------
// The Xero Payroll integration was ARCHIVED 2026-08-05 (unused). Full code:
// git tag archive/xero-integration. Its DB objects and migrations remain.
// ---------------------------------------------------------------------------
