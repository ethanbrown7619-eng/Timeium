...
async function loadLookups() {
  ...
  // The rule is exactly the "Leave" tick box on the job in Configure
  // (jobs.is_leave) — ticked means leave, and leave is request-only. Every
  // active leave type maps to one of these jobs via leave_types.job_id, so
  // there's a request route for all of them.
